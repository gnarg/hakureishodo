			...
			if (!r && (C(e), (e = e || T), E)) {
				if (11 !== f && (s = te.exec(t)))
					if ((l = s[1])) {
						...
						} else if (c && (i = c.getElementById(l)) && v(e, i) && i.id === l) return n.push(i), n;
					} else {
						if (s[2]) return P.apply(n, e.getElementsByTagName(t)), n;
						if ((l = s[3]) && d.getElementsByClassName && e.getElementsByClassName)
			...
			return (
				...
				le(function (e, t, n, r) {
					...
					if (e) {
						...
						(d = xe(d === t ? d.splice(l, d.length) : d)), v ? v(null, t, d, r) : P.apply(t, d);
				})
			);
		}
		function Ce(g, v) {
		...
		return (
			...
			(m = se.select =
				function (e, t, n, r) {
					...
					return (l || h(e, c))(r, t, !E, n, !t || (ne.test(e) && me(t.parentNode)) || t), n;
				}),
			...
			ajax: function (e, t) {
				...
				if (
					...
					try {
						(o.href = h.url),
							(o.href = o.href),
							(h.crossDomain = Wt.protocol + '//' + Wt.host != o.protocol + '//' + o.host);
					} catch (e) {
						h.crossDomain = !0;
					}
				}
				...
				h.hasContent
					...
					: ((o = h.url.slice(l.length)),
						...
						!1 === h.cache &&
							((l = l.replace(Mt, '$1')), (o = (It.test(l) ? '&' : '?') + '_=' + jt.guid++ + o)),
						(h.url = l + o)),
				h.ifModified &&
					...
					(g += ' mfp-gallery'),
						...
						c('BuildControls' + e, function () {
							...
							1 < h.items.length &&
								...
								((t = i.arrowMarkup),
								(e = h.arrowLeft =
									l(t.replace(/%title%/gi, i.tPrev).replace(/%dir%/gi, 'left')).addClass(a)),
								(t = h.arrowRight =
					...
					if (
						...
						(t = t || '#top' !== n ? t : document.documentElement) &&
							...
							history.replaceState &&
								...
								((e = (e = x.location.hash) || ''),
								history.replaceState(
									{ smoothScroll: JSON.stringify(n), anchor: e || x.pageYOffset },
									document.title,
									e || x.location.href
								)),
							b.animateScroll(t, o));
